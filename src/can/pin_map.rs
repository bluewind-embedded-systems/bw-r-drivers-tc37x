...
pub const PIN_RX_0_0_P20_7: RxdIn = RxdIn::new(M::Can0, N::Node0, P::_20, 7, RxSel::_B);
pub const PIN_RX_0_0_P12_0: RxdIn = RxdIn::new(M::Can0, N::Node0, P::_12, 0, RxSel::_C);
pub const PIN_RX_0_0_P33_12: RxdIn = RxdIn::new(M::Can0, N::Node0, P::_33, 12, RxSel::_D);
pub const PIN_RX_0_0_P33_7: RxdIn = RxdIn::new(M::Can0, N::Node0, P::_33, 7, RxSel::_E);
pub const PIN_RX_0_0_P34_2: RxdIn = RxdIn::new(M::Can0, N::Node0, P::_34, 2, RxSel::_G);
pub const PIN_RX_0_1_P15_3: RxdIn = RxdIn::new(M::Can0, N::Node1, P::_15, 3, RxSel::_A);
pub const PIN_RX_0_1_P14_1: RxdIn = RxdIn::new(M::Can0, N::Node1, P::_14, 1, RxSel::_B);
pub const PIN_RX_0_1_P01_4: RxdIn = RxdIn::new(M::Can0, N::Node1, P::_01, 4, RxSel::_C);
pub const PIN_RX_0_1_P33_10: RxdIn = RxdIn::new(M::Can0, N::Node1, P::_33, 10, RxSel::_D);
pub const PIN_RX_0_1_P02_10: RxdIn = RxdIn::new(M::Can0, N::Node1, P::_02, 10, RxSel::_E);
pub const PIN_RX_0_2_P15_1: RxdIn = RxdIn::new(M::Can0, N::Node2, P::_15, 1, RxSel::_A);
pub const PIN_RX_0_2_P02_3: RxdIn = RxdIn::new(M::Can0, N::Node2, P::_02, 3, RxSel::_B);
pub const PIN_RX_0_2_P32_6: RxdIn = RxdIn::new(M::Can0, N::Node2, P::_32, 6, RxSel::_C);
pub const PIN_RX_0_2_P14_8: RxdIn = RxdIn::new(M::Can0, N::Node2, P::_14, 8, RxSel::_D);
pub const PIN_RX_0_2_P10_2: RxdIn = RxdIn::new(M::Can0, N::Node2, P::_10, 2, RxSel::_E);
pub const PIN_RX_0_3_P00_3: RxdIn = RxdIn::new(M::Can0, N::Node3, P::_00, 3, RxSel::_A);
pub const PIN_RX_0_3_P32_2: RxdIn = RxdIn::new(M::Can0, N::Node3, P::_32, 2, RxSel::_B);
pub const PIN_RX_0_3_P20_0: RxdIn = RxdIn::new(M::Can0, N::Node3, P::_20, 0, RxSel::_C);
pub const PIN_RX_0_3_P11_10: RxdIn = RxdIn::new(M::Can0, N::Node3, P::_11, 10, RxSel::_D);
pub const PIN_RX_0_3_P20_9: RxdIn = RxdIn::new(M::Can0, N::Node3, P::_20, 9, RxSel::_E);
pub const PIN_RX_1_0_P00_1: RxdIn = RxdIn::new(M::Can1, N::Node0, P::_00, 1, RxSel::_A);
pub const PIN_RX_1_0_P14_7: RxdIn = RxdIn::new(M::Can1, N::Node0, P::_14, 7, RxSel::_B);
pub const PIN_RX_1_0_P23_0: RxdIn = RxdIn::new(M::Can1, N::Node0, P::_23, 0, RxSel::_C);
pub const PIN_RX_1_0_P13_1: RxdIn = RxdIn::new(M::Can1, N::Node0, P::_13, 1, RxSel::_D);
pub const PIN_RX_1_1_P02_4: RxdIn = RxdIn::new(M::Can1, N::Node1, P::_02, 4, RxSel::_A);
pub const PIN_RX_1_1_P00_5: RxdIn = RxdIn::new(M::Can1, N::Node1, P::_00, 5, RxSel::_B);
pub const PIN_RX_1_1_P23_7: RxdIn = RxdIn::new(M::Can1, N::Node1, P::_23, 7, RxSel::_C);
pub const PIN_RX_1_1_P11_7: RxdIn = RxdIn::new(M::Can1, N::Node1, P::_11, 7, RxSel::_D);
pub const PIN_RX_1_2_P20_6: RxdIn = RxdIn::new(M::Can1, N::Node2, P::_20, 6, RxSel::_A);
pub const PIN_RX_1_2_P10_8: RxdIn = RxdIn::new(M::Can1, N::Node2, P::_10, 8, RxSel::_B);
pub const PIN_RX_1_2_P23_3: RxdIn = RxdIn::new(M::Can1, N::Node2, P::_23, 3, RxSel::_C);
pub const PIN_RX_1_2_P11_8: RxdIn = RxdIn::new(M::Can1, N::Node2, P::_11, 8, RxSel::_D);
pub const PIN_RX_1_3_P14_7: RxdIn = RxdIn::new(M::Can1, N::Node3, P::_14, 7, RxSel::_A);
pub const PIN_RX_1_3_P33_5: RxdIn = RxdIn::new(M::Can1, N::Node3, P::_33, 5, RxSel::_B);
